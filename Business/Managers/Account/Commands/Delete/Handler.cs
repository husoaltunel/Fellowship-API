...
{
    public class Handler : BaseConnection, IRequestHandler<UserDeleteCommand, IDataResult<int>>
    {
        public Handler(IDbConnection connection)
        {
            Connection = connection;
        }
        public async Task<IDataResult<int>> Handle(UserDeleteCommand request, CancellationToken cancellationToken)
        {
